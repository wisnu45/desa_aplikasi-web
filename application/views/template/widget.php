...
<div class="widgett" >
  <nav style="margin-bottom: 10px;">
    <div class="nav nav-tabs border-success" id="nav-tab" role="tablist">
  ...
  <?php endforeach;?>
  <br>
  <a href="<?php echo site_url('berita'); ?>" class="btn btn-outline-success btn-block">Selengkapnya</a>
</div>
...
<?php endforeach;?>
<br>
<a href="<?php echo site_url('pengumuman'); ?>" class="btn btn-outline-success btn-block">Selengkapnya</a>
</div>
<div class="tab-pane fade" id="nav-agenda" role="tabpanel" aria-labelledby="nav-agenda-tab">
  ...
  <?php endforeach;?>
  <br>
  <a href="<?php echo site_url('agenda'); ?>" class="btn btn-outline-success btn-block">Selengkapnya</a>
</div>
</div>
</div>
<!-- Populer -->
<div class="card my-4">
  <h5 class="card-header bg-success text-white">Berita Populer</h5>
  <div class="card-body">
...
<!-- Categories Widget -->
<div class="card my-4">
 <h5 class="card-header bg-success text-white">Kategori Berita</h5>
 <div class="card-body">
