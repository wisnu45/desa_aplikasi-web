<div id="footer" class="footer">
	<div class="container">
		...
		Copyright &copy;  <?php echo date("Y") ?> Desa semamung | Made with <span i class="fa fa-heart" style="color:#DC3545"> </span> by Desa Semamung | Distributed by <a href="" target="_blank" rel="noopener noreferrer">Semamung</a>
	</div>
</div>
</main>
<?php $i = $ig->row_array()?>
