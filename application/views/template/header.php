...
<head>
	...
	<meta name="keyword" content="Desa semamung">
	<meta name="description" content="Portal Desa semamung">
	<!-- nggo responsive -->
	<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	<!-- favicon -->
	<link rel="icon" href="<?=base_url('assetss/favicon/') . $iden['favicon']?>">
	<title><?php echo SITE_NAME . " Desa Semamung - " . ucfirst($this->uri->segment(1)) ?></title>
	<!-- Bootstrap core CSS -->
