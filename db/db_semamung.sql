...
--
-- Host: 127.0.0.1
-- Generation Time: 28 Des 2020 pada 16.32
-- Versi Server: 5.5.39
-- PHP Version: 5.4.31
...
(14, 'Pelatihan Web Site', '2020-12-28 13:36:05', 'Pelatihan website yang diselnggarakan dinkominfo Purbalingga', '2019-02-06 08:00:00', '2019-02-06 11:30:00', 'Dinkominfo PBG', '#121da6', 'Wajib\r\n', 7, 'pelatihan-web-site'),
(15, 'Senam1', '2020-12-28 13:36:05', 'Test1', '2019-05-10 09:31:01', '2019-05-11 09:31:05', 'Lapangan1', '#7a2323', '', 7, 'senam1');
...
(1, 'Desa Semamung', '2020-12-28 13:22:26', 7, 0, '186a2cc0cdf6c3caf8d16d4a1d8499aa.jpg');
...
CREATE TABLE IF NOT EXISTS `tb_buka` (
`id` int(11) NOT NULL,
...
(1, 'A', '2020-12-28 13:22:51', '7192cef3c289d9fde5726c28354d3243.jpeg', 1, 7),
(6, 'Sambutan Camat1', '2020-12-28 13:14:30', '42be71a6af502a8cc4ffcbeb953b98c7.jpg', 1, 7),
(7, 'kkjj1', '2020-12-28 13:22:51', '035bd55b0961ee7722306e25bfdfaf1b.jpg', 1, 7),
(8, 'ewewe', '2020-12-28 13:22:51', '5b0b92075fa65e917e24074b381a0b11.jpeg', 1, 7);
...
(1, '0160ecde4f98ce7a0dcc614f16535091.png', '6213a72089d3b26f72d5f32186acf52f.png', 'webdesasemamung@gmail.com', ' Desa Semamung, Moyohulu Kabupaten  Sumbawa,Nusa Tenggara Barat, Indonesia', '0852041002', '<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63111.760880184476!2d117.37768234621778!3d-8.645331359561531!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dcb908115e11adb%3A0xf73c662fdcda7aba!2sSemamung%2C%20Moyohulu%2C%20Kabupaten%20Sumbawa%2C%20Nusa%20Tenggara%20Bar.!5e0!3m2!1sid!2sid!4v1609060054266!5m2!1sid!2sid" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>');
...
CREATE TABLE IF NOT EXISTS `tb_igfeed` (
`id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tb_jenispelayanan` (
`id` int(11) NOT NULL,
  `judul` varchar(80) NOT NULL,
  `isi` text
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=9 ;
...
CREATE TABLE IF NOT EXISTS `tb_potensi` (
`id` int(11) NOT NULL,
  `judul` varchar(150) NOT NULL,
  `tanggal` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `isi` text NOT NULL,
...
(1, 'c8531d57499f46b98b08a87c2796f567.jpg'),
(2, 'c650a0eb344863a747cea4b1b04044e1.jpeg'),
(3, 'af5f3639bcb1d488d1a907d0155bfed4.jpeg');
...
CREATE TABLE IF NOT EXISTS `tb_socmed` (
`id` int(11) NOT NULL,
...
(4, 'Facebook', 'https://www.facebook.com/desasemamung', 'fa fa-facebook'),
(8, 'Twitter', 'https://www.twitter.com/desasemamung', 'fa fa-twitter'),
(10, 'Instagram', 'https://www.instagram.com/desasemamung', 'fa fa-instagram'),
(12, 'Youtube', 'https:www.youtube.com/desasemamung', 'fa fa-youtube');
...
(1, 'Kata Sambutan', '<p><strong>Assalaamu&rsquo;alaikum Wr. Wb.</strong></p>\r\n\r\n<p><strong>Puji syukur senantiasa kita panjatkan kehadirat Allah SWT, Tuhan Yang Maha Esa yang telah melimpahkan rahmat, taufiq dan hidayah-Nya kepada kita sekalian sehingga Desa Semamung dapat membangun Web Site Desa Semamung.</strong></p>\r\n\r\n<p><strong>Sejalan dengan penerapan informasi dalam pelayanan publik, maka Web Site Desa Semamung merupakan suatu tuntutan Teknologi Informasi (TI) yang berkembang pesat pada saat ini. Website ini berisikan informasi-informasi yang dapat diakses masyarakat pengguna internet yang merupakan tindak lanjut dari Undang-Undang Nomor 14 Tahun 2008 tentang Keterbukaan Informasi Publik.</strong></p>\r\n\r\n<p><strong>Tujuan terbangunnya Web Site Desa Semamung ini adalah :</strong></p>\r\n\r\n<p><strong>1.Memajukan peradaban masyarakat di Desa Semamung<br />\r\n2.Memberikan informasi seluas-luasnya kepada masyarakat<br />\r\n3.Sebagai sarana komunikasi antara warga masyarakat dengan Pemerintah Desa Semamung<br />\r\nKami menyadari bahwa Web Site Desa Semamung ini masih jauh dari kesempurnaan, oleh karena itu kritik dan saran yang membangun sangat kami harapkan dalam kesempurnaan Web Site Desa ini.</strong></p>\r\n\r\n<p><strong>Terima Kasih</strong></p>\r\n\r\n<p><strong>Wassalaamu&rsquo;alaikum Wr. Wb.</strong></p>\r\n\r\n<p><strong>Kepala Desa Semamung</strong></p>\r\n\r\n<p><strong>Rudi Mustaid</strong></p>\r\n\r\n<p style="text-align:justify">&nbsp;</p>\r\n', '763824dcc3722aedc6c6285b8772a66f.jpg'),
...
(7, 'Admin Desa Semamung', 'admin@desasemamung.com', 'L', 'admin', '21232f297a57a5a743894a0e4a801fc3', '081928272531', '1', '1', '2020-12-28 12:44:06', 'fe2be503d272350a6c3c8daddbf63718.png');
...
--
CREATE TABLE IF NOT EXISTS `vw_berita` (
`id` int(11)
,`judul` varchar(150)
,`isi` text
,`tayang` int(11)
...
ALTER TABLE `tb_agenda`
 ADD PRIMARY KEY (`id`), ADD KEY `id` (`id`), ADD KEY `userid` (`userid`);
